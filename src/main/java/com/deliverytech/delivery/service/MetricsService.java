...
public class MetricsService {
    ...
    public MetricsService(MeterRegistry meterRegistry) {
        ...
        this.pedidosProcessados = Counter.builder("delivery.pedidos.total")
                .description("Total de pedidos processados").register(meterRegistry);
        ...
        this.pedidosComErro = Counter.builder("delivery.pedidos.erro")
                .description("Pedidos com erro no processamento").register(meterRegistry);
        this.receitaTotal = Counter.builder("delivery.receita.total")
                .description("Receita total em centavos").baseUnit("centavos").register(meterRegistry);
        ...
        // Inicializar gauges
        meterRegistry.gauge("delivery.usuarios.ativos", usuariosAtivos);
        meterRegistry.gauge("delivery.produtos.estoque", produtosEmEstoque);

        Gauge.builder("delivery.usuarios.ativos.v2", usuariosAtivos, AtomicInteger::get)
                .description("Número de usuários ativos")
                .register(meterRegistry);

        Gauge.builder("delivery.produtos.estoque.v2", produtosEmEstoque, AtomicLong::get)
